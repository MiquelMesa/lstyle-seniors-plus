...
const Seguretat = 
{
    ...
    prevenirSQLInjection(str) {
        ...
        // Com que la API MariaDB usa prepared statements, però afegim validació extra
    ...
    aplicarCSP() {
        ...
        meta.content = [
        "default-src 'self'",
        "script-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://unpkg.com https://fonts.googleapis.com",
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com",
        "img-src 'self' data: https:",
        "connect-src 'self' https://michaelprojects.org https://api.groq.com",
